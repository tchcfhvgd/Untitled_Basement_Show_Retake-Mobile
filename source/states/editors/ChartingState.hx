...
class ChartingState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	[
		...
		['Subtitles', "Text Of What's The Guy Saying\nValue 1: The Text\nValue 2: Color (in rgb)\nleave blank = white, char name (dad,bf) = bf/dad color"],
		['Set GF Speed', "Sets GF head bopping speed,\nValue 1: 1 = Normal speed,\n2 = 1/2 speed, 4 = 1/4 speed etc.\nUsed on Fresh during the beatbox parts.\n\nWarning: Value must be integer!"],
		['Add Camera Zoom', "Used on MILF on that one \"hard\" part\nValue 1: Camera zoom add (Default: 0.015)\nValue 2: UI zoom add (Default: 0.03)\nLeave the values blank if you want to use Default."],
		['Camera Modulo Change', "Sets The Beats The Cam Should Zoom\nValue 1: Beats For Zoom\nValue 2: Intensity For camGame & camHUD\nexample (1,1)."],
		['Cinematics', "If You Know You Know\nValue 1: New Size (0 = Invs, 1 = Taken The Screen)\nValue 2: Speed. (In Seconds)"],
		['Change Zoom', 'sets zoom.\nvalue1: zoom value, value2: tween speed'],
		['Flash Cam', 'you know dude it\'s 2025.\nvalue1:Camera Name,speed value2:color (in rgb)'],
		...
		['Event Trigger', "Useless Event Unless You Setted The Settings For It."] // basically those scripts cases but as an event for more accuracy and less pain
	];
