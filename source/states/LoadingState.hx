...
class LoadingState extends MusicBeatState
{
	...
	var theChances:Float = 0;

	var loadingRandomies:Array<String> = [
	'The Creator (MrSropical) Says The Old Version SUCKS',
	'This Mod Is Cancelled.',
	'I Ate Your Doorframe',
	'This Mod Was Supposed To Came In 2023 If MrSropical Did Exist',
	'This Mod Was Supposed To Be In Codename Engine, But Then Ported To Psych Engine For Mod Revivors',
	'This Mod Is Cancelled Due The MrSropical Becoming An Actual TBS Dev',
	'You Should Stop Using Psych Engine 0.6.3',
	'I Left Mod Support',
	'Incase Some Songs Does A LagSpike & Breaks The Events, Just Restart The Song.',
	'You Can Type On The Menu "SIGMA" To Enable Cheats',
	'There\'s A Rare Text You Can Find If You\'re Lucky',
	'The Reason FNF Is Not For Kids Is Because The "Mods" They\'re About To Create',
	'Juki Is The New Owner Of UBSR',
	'"I Eat Lua For BreakFast."',
	'A Coder\'s Head Explodes Once They Hear The Word "Does It Support OS Engine" When Publishing A Script',
	'House For Sale Wasn\'t Supposed To Be In The Build, It Was Only There For Testing Purposes.',
	'This Is A Random Tip',
	'If You\'re Still Suck In This Game In 2025, Then It\'s A Big Shame.',
	...
	override function create()
	{
		...
		loadingText = new FlxText(520, 600, FlxG.width, Language.getPhrase('now_loading', 'Now Loading', ['...']), 32);
		...
		var dText:FlxText = new FlxText(520, 500, FlxG.width, 'Did You Know?', 20);
		dText.setFormat(Paths.font("vcr.ttf"), 32, FlxColor.WHITE, CENTER, OUTLINE_FAST, FlxColor.BLACK);
		dText.screenCenter(X);
		dText.borderSize = 2;
		addBehindBar(dText);

		theChances = FlxG.random.int(0,50);

		var qText:FlxText = new FlxText(520, 530, FlxG.width, ((theChances == 20) ? 'THIS IS THE RAREST MESSAGE!!!!!\n QUICK TAKE A SCREENSHOT ASAP!!!!': loadingRandomies[FlxG.random.int(0,loadingRandomies.length-1)]), 20);
		qText.setFormat(Paths.font("vcr.ttf"), 25, FlxColor.WHITE, CENTER, OUTLINE_FAST, FlxColor.BLACK);
		qText.screenCenter(X);
		qText.borderSize = 2;
		addBehindBar(qText);
	...
	override function update(elapsed:Float)
	{
		...
		if (!transitioning)
		{
			if (!finishedLoading && checkLoaded())
			{
				...
				{
					new FlxTimer().start(FlxG.random.float(0.01, 4), function(tmr:FlxTimer){ // stay in the loading screen abit more :)
					loadingText.text = 'Loading Complete (Press Enter To Continue)';
		...
		openfl.Lib.application.window.title = "Untitled Basement Show Retake: Refreshed | Loading" + dots;
	}
