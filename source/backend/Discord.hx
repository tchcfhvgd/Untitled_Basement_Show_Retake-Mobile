...
class DiscordClient
{
	...
	private inline static final _defaultID:String = "1348016915687280823";
	...
	public static function changePresence(details:String = 'In the Menus', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
		...
		presence.smallImageKey = 'https://static.wikia.nocookie.net/fridaynightfunking/images/c/cb/TBSLogo.png/revision/latest?cb=20220731042355';
		presence.largeImageKey = 'https://pouch.jumpshare.com/preview/KQPhKzkuDZJyusN1w08DAwa6eAVGFY9bYJkhtN4ehugVP4eG61rlhVHyNOcAfcA8-S_D8pPCwTDjb71smdFAm1YccHBbRpEsQCG805RA_m8';
		presence.largeImageText = "Version: 0.2.0  (Cancelled Build)";
