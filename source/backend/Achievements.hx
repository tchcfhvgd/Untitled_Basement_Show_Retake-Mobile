...
class Achievements {
	...
	{
		// ofc these names are absolute shit that's what achievemnts are.
		createAchievement('friday_night_play',		{name: "Freaky on a Friday Night", description: "Play on a Friday... Night.", rarity: "Doable", hidden: true});
		createAchievement('week1_nomiss',			{name: "Accepted Deal", description: "Beat Week 1 with no Misses on Hard Mechanics.", rarity: "Insane"});
		createAchievement('week2_nomiss',			{name: "Less Hearthborken", description: "Beat Week 2 with no Misses.", rarity: "Doable"});
		createAchievement('dod_nomiss',			    {name: "Tough Meal", description: "Beat Desire or Despair with no Misses On Hard Mechanics.", rarity: "Mid"});
		createAchievement('mm_nomiss',			    {name: "Respect Points++", description: "Beat Meme Mania with no Misses.", rarity: "Mid"});
		createAchievement('fb_nomiss',			    {name: "Cold Blooded Combo", description: "Beat Frozen Bell with no Misses On Hard Mechanics.", rarity: "Mid"});
		createAchievement('zerodg',			        {name: "Silent Wind", description: "Beat A Week 1 Song (Evaporate/Sirokou) With 0 Missed Dodges.", rarity: "Hard"});
		createAchievement('js',	                    {name: "Ain't Afraid Of Jumpscares", description: "Hit 30 Knife Notes In Sirokou.", maxScore: 30, maxDecimals: 0, rarity: "Mid"});
		createAchievement('despair',				{name: "Giving Up...", description: "Die In Desire or Despair With The Despair Bar Being Full.", rarity: "Doable"});
		createAchievement('snowHit',	            {name: "Snow Blower Aqquiring", description: "Hit 50 Snow Notes Notes In Frozen Bell.", maxScore: 50, maxDecimals: 0, rarity: "Insane"});
		createAchievement('ur_bad',					{name: "What a Funkin' Disaster!", description: "Complete a Song with a rating lower than 20%.", rarity: "Mid"});
		createAchievement('ur_good',				{name: "Perfectionist", description: "Complete a Song with a rating of 100%.", rarity: "Mid"});
		//createAchievement('oversinging', 			{name: "Oversinging Much...?", description: "Sing for 10 seconds without going back to Idle.", rarity: "Hard"}); both of these achievements are impossible.
		createAchievement('hype',					{name: "Hyperactive", description: "Finish a Song without going back to Idle.", rarity: "Insane"});
		//createAchievement('two_keys',				{name: "Just the Two of Us", description: "Finish a Song pressing only two keys.", rarity: "Impossible"});
		createAchievement('toastie',				{name: "Toaster Gamer", description: "Have you tried to run the game on a toaster?", rarity: "Doable"});
	...
	public static function unlock(name:String, autoStartPopup:Bool = true):String {
		...
		ClientPrefs.data.awardsPerc += 7.69;
