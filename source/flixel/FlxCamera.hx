...
class FlxCamera extends FlxBasic
{
	...
	public function pushFilter(shader:String, filter:BitmapFilter):Void
	{
		_filters.push(filter);
		_filterMap.set(shader, filter);
	}

	public function removeFilter(shader:String):Void
    {
        var youknow:BitmapFilter = _filterMap.get(shader);
        _filters.remove(youknow);
    }
