	...
	public function changeCharacter(?character:String = 'bf') {
		...
		switch(character) {
			case '':
				...
				dontPlayAnim = true;
			default:
				var characterPath:String = 'menus/story_mode/images/menucharacters/' + character + '.json';
				...
				frames = Paths.getSparrowAtlas('menus/story_mode/menucharacters/' + charFile.image);
