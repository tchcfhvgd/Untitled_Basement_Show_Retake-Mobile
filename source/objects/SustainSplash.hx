...
//CODE FROM P-SCLICE, THE ENGINE IS VERY GOOD TO USE CHECK IT OUT
// Edited For CN Lost Episodes By MrSropical.
class SustainSplash extends FlxSprite
{
	...
	public function new():Void
	{
		...
		frames = Paths.getSparrowAtlas('game/noteSplashes/holdCovers/holdCover');
	...
	public function setupSusSplash(strum:StrumNote, daNote:Note, ?playbackRate:Float = 1):Void
	{
		...
		var tailEnd:Note = !daNote.isSustainNote ? daNote.tail[daNote.tail.length] : daNote.parent.tail[daNote.parent.tail.length - 2];
